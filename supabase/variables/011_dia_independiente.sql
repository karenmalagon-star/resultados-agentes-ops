-- ============================================================================
-- Módulo de Variables · 011 · Corrección de auditoría: el filtro de fechas de la tabla mensual NO debe mover la tabla del día
--  · el día (p_dia) se calcula con sus propios eventos/asignaciones (ev_d/asg_d/ad_d), independientes del rango d_ini..d_fin
--  · cargo/turno "de hoy" = última asignación hasta el día mostrado; asignaciones_hoy = siempre las de HOY
-- ============================================================================
